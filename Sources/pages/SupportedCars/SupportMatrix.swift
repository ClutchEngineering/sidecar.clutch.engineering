...
let makes: [Make: [Model: [VehicleSupportStatus]]] = [
  ...
  "Hyundai": [
    ...
    "IONIQ 5": [
      ...
      .init(years: 2023...2023, testingStatus: .activeTester("spenumatsa"), stateOfCharge: .obd, stateOfHealth: .obd, charging: .obd, cells: .unk, fuelLevel: .na, speed: .unk, range: .unk, odometer: .obd, tirePressure: .obd),
      .init(years: 2024...2024, testingStatus: .activeTester("zachmiles"), stateOfCharge: .obd, stateOfHealth: .obd, charging: .unk, cells: .unk, fuelLevel: .na, speed: .obd, range: .unk, odometer: .obd, tirePressure: .obd),
      .testerNeeded(years: 2025...2025)
    ],
    "IONIQ 6": [
