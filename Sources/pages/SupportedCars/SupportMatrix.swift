...
let makes: [Make: [Model: [VehicleSupportStatus]]] = [
  ...
  "Hyundai": [
    ...
    "IONIQ 5": [
      ...
      .init(years: 2023...2023, testingStatus: .activeTester("spenumatsa"), stateOfCharge: .obd, stateOfHealth: .obd, charging: .obd, cells: .unk, fuelLevel: .na, speed: .obd, range: .unk, odometer: .obd, tirePressure: .obd),
      .init(years: 2024...2024, testingStatus: .activeTester("zachmiles"), stateOfCharge: .obd, stateOfHealth: .obd, charging: .obd, cells: .unk, fuelLevel: .na, speed: .obd, range: .unk, odometer: .obd, tirePressure: .obd),
      .testerNeeded(years: 2025...2025)
    ],
    "IONIQ 6": [
    ...
    "Tucson": [
      ...
      .init(years: 2019, testingStatus: .activeTester("BradP1011"), stateOfCharge: .na, stateOfHealth: .na, charging: .na, cells: .na, fuelLevel: .obd, speed: .obd, range: .unk, odometer: .unk, tirePressure: .obd),
      .testerNeeded(years: 2021),
  ...
  "Nissan": [
    ...
    " Pathfinder": [
      .testerNeeded(years: 1996...2023),
      .init(years: 2024, testingStatus: .onboarded, fuelLevel: .obd, speed: .obd, odometer: .obd),
      .testerNeeded(years: 2025),
    ],
    " Qashqai": [
