...
public class MergedSupportMatrix {
    ...
    public struct ModelSupport {
        ...
        public init(make: String, model: String, yearCommandSupport: [Int: CommandSupport] = [:]) {
            self.make = make
            self.model = model
    ...
    @discardableResult
    public func loadAndMerge(using airtableClient: AirtableClient, modelsTableID: String, workspacePath: String) async -> Bool {
        do {
