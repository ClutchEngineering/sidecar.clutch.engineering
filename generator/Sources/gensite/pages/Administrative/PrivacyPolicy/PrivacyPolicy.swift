...
This Privacy Notice is meant to help you understand how Fearless Design, LLC, a California limited liability company (“_**Fearless**_”, “_**we**_”, “_**our**_” or “_**us**_”) collects, uses, stores and shares personal information it collects about you (“_**User**_” “_**you**_” or “_**your**_”) in connection with your use of \(appName), our mobile application (hereinafter referred to as “_**Mobile App**_” or “_**\(appName)**_”), and how to exercise the choices and rights you have in your information.
...
We do not sell your personal information to third parties for money -- no one can buy the personal information we collect from and about you and we do not act as a data broker. All personal information collected by Fearless is stored by Fearless with PostHog and Statsig, event-based analytics providers, indefinitely. The personal information stored by Fearless with PostHog and Statsig is not utilized to provide you with targeted advertisements. PostHog and Statsig use the personal information collected by Fearless only to provide Fearless with event-based analytics information that is then used to improve your user experience. PostHog's privacy policy is available [here](https://posthog.com/privacy). Statsig's privacy policy is available [here](https://statsig.com/privacy). You can turn off data being sent to PostHog from the Settings page of the \(appName) app.

This website also reports how it is used to Clutch Telemetry, an analytics service operated by Fearless: the pages you visit and how you use them, the site that referred you, how quickly pages load, and basic browser settings such as language, together with a random identifier stored in your browser. This information is not linked to any app or account, and your IP address is not stored with it. You can turn it off with the Analytics switch at the bottom of any page of this website. The choice is kept in your browser, and nothing is sent from a browser that sends a Global Privacy Control signal.
...
If you would like to access your personal information, please email [privacy@clutch.engineering](mailto:privacy@clutch.engineering).
